...
def saveWifiConf(e,networkLbl,dd,ta):
    option = " "*32
...
def execScreenConf():
    ...
    miCabecera.strTitle="Galdeano IoT"
    ...
    dd.add_event_cb(event_handler_DD, lv.EVENT.ALL, None)
    ...
    cb.add_event_cb(autoStartup, lv.EVENT.ALL, None)
    ...
    btn3.add_event_cb(lambda e: scanWifi(e,dd), lv.EVENT.CLICKED, None)
    ...
    btn4.add_event_cb(lambda e: saveWifiConf(e,networkLbl,dd,ta), lv.EVENT.CLICKED, None)
...
def ligthOn(e,group,PhilipsHubAddr):
    code = e.get_code()
    obj = e.get_target()
    if code == lv.EVENT.VALUE_CHANGED:
...
def slider_event_cb(e,group,PhilipsHubAddr):
    slider = e.get_target()
...
def execScreen():
    ...
    mesaSsw.add_event_cb(lambda e: ligthOn(e,2,PhilipsHubAddr) ,lv.EVENT.ALL, None)
    ...
    mesaSlider.add_event_cb(lambda e: slider_event_cb(e,2,PhilipsHubAddr) , lv.EVENT.VALUE_CHANGED, None)
    ...
    pianoSsw.add_event_cb(lambda e: ligthOn(e,3,PhilipsHubAddr) ,lv.EVENT.ALL, None)
    ...
    pianoSlider.add_event_cb(lambda e: slider_event_cb(e,3,PhilipsHubAddr) , lv.EVENT.VALUE_CHANGED, None)
    ...
    sofaSsw.add_event_cb(lambda e: ligthOn(e,4,PhilipsHubAddr),lv.EVENT.ALL, None)
    ...
    sofaSlider.add_event_cb(lambda e: slider_event_cb(e,4,PhilipsHubAddr) , lv.EVENT.VALUE_CHANGED, None)
