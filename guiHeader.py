...
class guiHeader:
    ...
    def setHeader(self):
        self.objHeader = lv.obj(lv.screen_active())
        self.objHeader.set_size(320, 22)
        self.objHeader.align_to(lv.screen_active(), lv.ALIGN.TOP_LEFT, 0, 0)
        
        self.styleHeader = lv.style_t()
        self.styleHeader.init()
        self.styleHeader.set_bg_color(lv.color_hex(0x8080FF))
        self.styleHeader.set_text_color(lv.color_hex(0x101000))
